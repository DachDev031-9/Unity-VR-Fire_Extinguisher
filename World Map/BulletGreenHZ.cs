...
public class BulletGreenHZ : MonoBehaviour{
    ...
    void Update(){
        if (RightHandStatus == true && SelectObjectStatus == true && ActivateObjectStatus == true && AreaWM.Area_Fire == true && LatchGreenHZ.LatchStatus_GreenHZ == true){
            Bullet_Fire.SetActive(true);
            if (PlaySoundStatus == true){
                PlaySound();
                CheckBullet = true;
            }
        }else if (LeftHandStatus == true && SelectObjectStatus == true && ActivateObjectStatus == true && AreaWM.Area_Fire == true && LatchGreenHZ.LatchStatus_GreenHZ == true){
            Bullet_Fire.SetActive(true);
            if (PlaySoundStatus == true){
                PlaySound();
                CheckBullet = true;
